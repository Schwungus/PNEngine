...
global.u_material_half_lambert = new Uniform("u_material_half_lambert", UniformTypes.INTEGER)
global.u_material_cel = new Uniform("u_material_cel", UniformTypes.FLOAT)
...
global.u_texture_size = new Uniform("u_texture_size", UniformTypes.INTEGER)
...
global.u_bloom = new Uniform("u_bloom", UniformTypes.FLOAT)
